...
var pcshelper = {
    download : function (key){
        ...
        //var akey = key.split('.');
        //return {'url':('http://pan.baidu.com/api/search?&dir=&web=1&key=' + encodeURIComponent(akey[2] + "." + akey[3] + ".mp4") + '&recursion&timeStamp=' + Math.random())};
        var akey = key.split('.');
        var vp = '/node/' + akey[2] + "/" + akey[1] + '/' + akey[0] + '/';
        return {'url':
    ...
    upload : function (key){
        ...
        var vp = '/node/' + akey[2] + "/" + akey[1] + '/' + akey[0] + '/';
        var path = encodeURIComponent(vp + akey[3] + ".mp4");
        var cfg = {
        ...
        //https://pcs.baidu.com/rest/2.0/pcs/file?method=rapidupload&app_id=250528&path=%2F%E6%B5%8B%E8%AF%95%E5%BA%94%E7%94%A8%2F91ad999814895e979c79be9bca9882f9&content-length=148645974&content-md5=91ad999814895e979c79be9bca9882f9&slice-md5=b60cc48eef06505537936fd3a66b0344&contentcrc32=1373590915
